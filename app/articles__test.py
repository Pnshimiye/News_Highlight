...
class ArticleTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_article = Article('Python','Python is getting Crazy','http://www.abc.net.au/news/2019-02-16/eight-vale-sa-employees-arrested-over-deadly-brazil-dam-collapse/10818196','https://www.python.org/download/other/','2019-02-15T09:35:16Z')
